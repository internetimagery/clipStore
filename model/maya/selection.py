...
class Selection(object):
    def current(s):
        ...
        return dict( (a, dict((b, True if not channels or b in channels and cmds.attributeQuery(b, n=a, ex=True) else False) for b in cmds.listAttr(a, k=True))) for a in cmds.ls(sl=True, type="transform") )
