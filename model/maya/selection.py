...
class Selection(object):
    def current(s):
        ...
        return dict( (a, dict((b, True if not channels or b in channels else False) for b in cmds.listAttr(a, k=True) if cmds.attributeQuery(b, n=a, ex=True))) for a in objects )
